...
// API strings
var currentAPI = baseUrl+project+yr1+yr1first+tail+'&quality_grade=research&updated_since=2022-01-01'
var pastAPI = baseUrl+project+yr0+yr0first+tail+'&quality_grade=research&updated_since=2021-01-01'
  ...
  ////  console.log(`thisdataKeys: ${Object.keys(thisData)}`)
          ...
          svg.append("path")
            ...
            function mousemove() {
              ...
              focusText
                .html(selectedData.count.toLocaleString() + " IDs")
