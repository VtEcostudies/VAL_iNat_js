var baseUrl = 'https://api.inaturalist.org/v1/observations/observers?';
...
Promise.all([fetch(allyrsAPI),
      ...
      // totalSpp, current yr, past year
          observerData=[data1[0],data1[1],data1[2]]

          console.log(`observerData: ${Object.values(observerData)}`)

              })
        .then(function(){
        //  interval value
        var htmlID = "observersVT";
          ...
          var svg = d3.select("#" + htmlID)
            ...
            var x = d3.scaleLinear()
              ...
              // add x axis label
                svg.append("text")
                   ...
                   .attr("x", x(observerData[0]/2))
                   .attr("y", height+40)
                   .text("Observers");

                   // Bars
                   var sppTotBar = svg.selectAll(".totobservers")
                       .data(observerData)
                       .enter()
                       .append("rect");
                   ...
                   sppTotBar.attr("x", function(d){return x(0)})
                       ...
                       .attr("width", function(d){ return x(observerData[0])})
                       .attr("height", 28)
                       .attr("fill", "#D0D0D0");
              ...
              var sppYrBar = svg.selectAll(".yrsppbar")
                  ...
                  sppYrBar.attr("x", function(d){return x(0)})
                           ...
                           .attr("width", function(d){ return x(observerData[1])})
                           .attr("height", 10)
                           .attr("fill", "#00CC00");
                           // Bars
            ...
            var sppLastBar = svg.selectAll(".lastsppbar")
                    ...
                    sppLastBar.attr("x", function(d){return x(observerData[2])})
